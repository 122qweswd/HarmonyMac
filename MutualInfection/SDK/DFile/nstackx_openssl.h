...
NSTACKX_EXPORT uint32_t AesGcmDecrypt(uint8_t *inBuff, uint32_t inLen, CryptPara *cryptPara,
    uint8_t *outBuff, uint32_t outLen);
// 添加ChaCha20-Poly1305函数声明
NSTACKX_EXPORT uint32_t ChaCha20Poly1305Encrypt(const uint8_t *inBuf, uint32_t inLen, CryptPara *cryptPara,
    uint8_t *outBuf, uint32_t outLen);
NSTACKX_EXPORT uint32_t ChaCha20Poly1305Decrypt(uint8_t *inBuf, uint32_t inLen, CryptPara *cryptPara,
    uint8_t *outBuf, uint32_t outLen);
