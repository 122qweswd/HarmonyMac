...
enum {
    ...
    INTERNAL_CAPS_CRC_CHECK,
    INTERNAL_CAPS_DEVICE_L2,
    INTERNAL_CAPS_EMPTY_DIR,
    INTERNAL_CAPS_CLEAR_POLICY,
    INTERNAL_CAPS_RECV_MMSG,
    INTERNAL_CAPS_ENCRYPT_CRTLMSG,
...
#define NSTACKX_INTERNAL_CAPS_CLEAR_POLICY           NBITS(INTERNAL_CAPS_CLEAR_POLICY)
#define NSTACKX_INTERNAL_CAPS_ENCRYPT_CTRLMSG        NBITS(INTERNAL_CAPS_ENCRYPT_CRTLMSG)
