...
import { T as isTestDefaultMemorySlotDisabled, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BYxmP5sL.js";
...
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-BaYMJaPE.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-jWPP5mj2.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Dk6shXz_.js";
import { t as isWithinDir } from "./path-safety-Z97FO1K-.js";
import "./install-safe-path-DZM2JHcC.js";
import "./skill-scanner-Ms0uZYdw.js";
import { n as formatConfigIssueLines } from "./issue-format-DzWr6rWA.js";
import { t as buildChannelAccountSnapshot } from "./status-DvTwuEy3.js";
import "./channels-status-issues-D0D1GN5e.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-ChXNrf2k.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-Cs9jeoAI.js";
...
import { t as discoverGatewayBeacons } from "./bonjour-discovery-C3gDSI_R.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BTn1xYPY.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-B963887J.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-RQL5Ujhs.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-ZdHmowIU.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BnD-aJCA.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./auth-profiles-CUUGuGNp.js").then((n) => n.Wa);
