...
import { t as loginOpenAICodexOAuth } from "./openai-codex-oauth-C28qYZZS.js";
import { n as validateAnthropicSetupToken } from "./auth-token-Ckjr9YaA.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-CUUGuGNp.js").then((n) => n.wg);
