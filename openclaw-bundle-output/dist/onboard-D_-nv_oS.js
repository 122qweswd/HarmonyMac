...
import { Dt as randomToken, Mt as waitForGatewayReachable, Ot as resolveControlUiLinks, Pg as readConfigFileSnapshot, Rg as writeConfigFile, St as normalizeGatewayTokenInput, _t as ensureWorkspaceAndSessions, bt as handleReset, mt as applyWizardMetadata, pt as DEFAULT_WORKSPACE } from "./auth-profiles-CUUGuGNp.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-qT4x04Kd.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C0b0ewmK.js");
