...
import { Pg as readConfigFileSnapshot, Rg as writeConfigFile } from "./auth-profiles-CUUGuGNp.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./auth-profiles-CUUGuGNp.js").then((n) => n.Ct);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BIKSaYD0.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-D4ENEFLU.js").then((n) => n.r);
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-C9qIRlS-.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-NnVSj3m5.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-DPTMkgId.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-Ck6OSsjJ.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-BU59VRoQ.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-Dt_GZOa9.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { setupChannels } = await import("./onboard-channels-BiW3i8mB.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-l-9fcZXj.js").then((n) => n.t);
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-41A6w_1q.js");
