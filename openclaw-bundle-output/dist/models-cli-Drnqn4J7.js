...
import { n as validateAnthropicSetupToken } from "./auth-token-C7Thla13.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./reply-VlVWWWSj.js").then((n) => n.pf);
