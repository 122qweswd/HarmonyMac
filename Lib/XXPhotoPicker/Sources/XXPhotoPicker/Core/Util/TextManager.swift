...
public extension HX.TextManager {
    ...
    struct Picker {
        ...
        public struct PhotoList {
            ...
            public struct Cell {
                public var gifTitle: TextType = .custom("GIF")
                public var LivePhotoTitle: TextType = .custom("")
        ...
        public struct BottomView {
            ...
            public var previewTitleFont: UIFont = .systemFont(ofSize: 16)
            public var editTitle: TextType = .localized("编辑")
            public var editTitleFont: UIFont = .systemFont(ofSize: 16)
            public var originalTitle: TextType = .localized("原图")
            public var originalTitleFont: UIFont = .systemFont(ofSize: 16)
        }
    }
    #endif
