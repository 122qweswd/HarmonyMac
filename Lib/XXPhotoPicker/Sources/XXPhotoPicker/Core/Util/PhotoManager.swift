...
public final class PhotoManager: NSObject {
    ...
    func createBundle() -> Bundle? {
        if self.bundle == nil {
            ...
            if let path = Bundle.module.path(forResource: "XXPhotoPicker", ofType: "bundle") {
