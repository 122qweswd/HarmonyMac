...
public protocol PhotoHUDProtocol: UIView {
    ...
    @discardableResult
    static func showText(with text: String?, delay: TimeInterval, animated: Bool, addedTo view: UIView?) -> PhotoHUDProtocol?
...
extension ProgressHUD: PhotoHUDProtocol {
    public static func showText(with text: String?, delay: TimeInterval, animated: Bool, addedTo view: UIView?) -> PhotoHUDProtocol? {
