...
extension PhotoPickerController: PhotoPickerDataDelegate {
    public func pickerDataWillSelectAllAsset(_ pickerData: PhotoPickerData) {
        pickerDelegate?.pickerDataWillSelectAllAsset(self)
    }
    
    public func pickerDataDidSelectAllAsset(_ pickerData: PhotoPickerData) {
        pickerDelegate?.pickerDataDidSelectAllAsset(self)
    }
