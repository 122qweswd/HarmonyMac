...
extension PhotoPreviewViewController {
    @objc func didSelectBoxControlClick() {
        ...
        if canUpdate {
            updateSelectBox(photoAsset: photoAsset, isSelected: isSelected, pickerUpdateCell: pickerUpdateCell, bottomNeedAnimated: bottomNeedAnimated)
        }
    }
    
    func updateSelectBox(photoAsset: PhotoAsset, isSelected: Bool, pickerUpdateCell: Bool, bottomNeedAnimated: Bool) {
        if isShowToolbar {
