...
public extension PhotoAsset {
    ...
    /// - Returns: 请求ID
    @discardableResult
    func requestThumbnailImage(localType: DonwloadURLType = .thumbnail,targetWidth: CGFloat = 180,completion: ((UIImage?, PhotoAsset, [AnyHashable: Any]?) -> Void)?) -> PHImageRequestID? {
        #if HXPICKER_ENABLE_EDITOR
