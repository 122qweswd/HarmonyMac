...
public protocol PhotoNavigationItemDelegate: PhotoControllerEvent {
    ...
    func photoItem(_ photoItem: PhotoNavigationItem, didSelectedAll isSelected: Bool)
    func photoItem(_ photoItem: PhotoNavigationItem, didBackClick isSelected: Bool)
