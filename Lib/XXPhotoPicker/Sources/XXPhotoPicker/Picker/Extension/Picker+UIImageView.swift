...
extension HXImageViewProtocol {
    ...
    func setImage(for asset: PhotoAsset, urlType: DonwloadURLType, forciblyOriginal: Bool = false, indicatorColor: UIColor? = nil, progressBlock: ((CGFloat, PhotoAsset) -> Void)? = nil, taskHandler: ((Any, PhotoAsset) -> Void)? = nil, completionHandler: ((UIImage?, PhotoAsset) -> Void)? = nil) -> ImageDownloadTask? {
