...
public class PhotoImageBackItemView: UIView, PhotoNavigationItem {
    ...
    func initView() {
        ...
        let imageType: HX.ImageResource.ImageType = .imageResource.picker.preview.back
        button.setImage(imageType.image, for: .normal)
