...
//        manager.fetchLimit = 200
    ...
    lazy var pickerView: XXPhotoPicker.PhotoPickerView = {
        let view = XXPhotoPicker.PhotoPickerView(
            manager: manager,
...
extension WindowPickerViewController: PhotoPickerViewDelegate {
    ...
    func photoPickerView(
        _ photoPickerView: XXPhotoPicker.PhotoPickerView,
    ...
    func photoPickerView(_ photoPickerView: XXPhotoPicker.PhotoPickerView, didSelectAsset photoAsset: PhotoAsset, at index: Int) {
        requestFileSize()
        finishButton.isEnabled = !pickerView.selectedAssets.isEmpty
    }
    
    func photoPickerView(_ photoPickerView: XXPhotoPicker.PhotoPickerView, didDeselectAsset photoAsset: PhotoAsset, at index: Int) {
        requestFileSize()
        finishButton.isEnabled = !pickerView.selectedAssets.isEmpty
    }
    
    func photoPickerView(_ photoPickerView: XXPhotoPicker.PhotoPickerView, previewDidOriginalButton isSelected: Bool) {
